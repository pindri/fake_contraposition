...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(entity=WANDB_ENTITY, project="pag_cifar10_vgg_sampling_best", sweep=sweep_configuration)
    wandb.agent(sweep_id, function=lambda: sampling("cifar10", "vgg11_bn", "pgd"))

    sweep_id = wandb.sweep(entity=WANDB_ENTITY, project="pag_cifar10_vgg_test_best", sweep=sweep_configuration)
    wandb.agent(sweep_id, function=lambda: testing("cifar10", "vgg11_bn","pgd"))
