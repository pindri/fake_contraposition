...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(entity="peter-blohm-tu-wien", project="pag_cifar10_sample_train_normal",
                           sweep=sweep_configuration)
    wandb.agent(sweep_id, function=lambda: sampling("cifar10", "resnet18","pgd"))
    sweep_id = wandb.sweep(entity="peter-blohm-tu-wien", project="pag_cifar10_test_normal", sweep=sweep_configuration)
