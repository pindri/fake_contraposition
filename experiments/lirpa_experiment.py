...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(entity=WANDB_ENTITY, project="pag_mnist_sampling_best_lirpa", sweep=sweep_configuration)
    wandb.agent(sweep_id, function=lambda: sampling("mnist", "feed_forward","lirpa"))

    sweep_id = wandb.sweep(entity=WANDB_ENTITY, project="pag_mnist_test_best_lirpa", sweep=sweep_configuration)
