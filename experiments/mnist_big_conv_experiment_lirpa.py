...
if __name__ == "__main__":
    with open("mnist_big_conv_lirpa.yaml", 'r') as stream:
    ...
    sweep_id = wandb.sweep(entity=WANDB_ENTITY, project="pag_mnist_test_best_big_conv", sweep=sweep_configuration)
