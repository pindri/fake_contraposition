...
def sampling():
    ...
    df.to_csv(f"../results/{wandb.config.optimization_function}_{wandb.config.seed}.csv", index=False)
...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(entity="peter-blohm-tu-wien", project="pag_mnist_sampling2", sweep=sweep_configuration)
